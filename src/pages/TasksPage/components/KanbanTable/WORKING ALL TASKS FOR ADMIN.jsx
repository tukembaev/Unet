  ...
  return (
    <div className={styles.wrapper}>
      <div  className={styles.item__wrapper}>
        <KanbanTableItem termTitle="Просроченны" termTasks1={overdue ?? []} term={term.overdue}/>
      </div>
     <div className={styles.item__wrapper}>
        <KanbanTableItem termTitle="На сегодня" termTasks1={today  ?? []} term={term.today}/>
      </div>
      <div className={styles.item__wrapper}>
        <KanbanTableItem termTitle="На этой неделе" termTasks1={week ?? []} term={term.week}/>
      </div>
      <div className={styles.item__wrapper}>
        <KanbanTableItem termTitle="Без срока" termTasks1={indefinite ?? []} term={term.noDeadline}/>
      </div>
    </div>
  )
}
