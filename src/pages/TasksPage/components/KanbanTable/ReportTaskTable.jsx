          ...
          return (   
            <tr key={item.id} className={styles.table__row}>
              <td className={styles.table__item}>
                <span className={styles.table__title}   style={{ wordBreak: "break-word" }}>{item.task_name} {item.subtask_name}</span>
              </td>
              <td className={styles.table__item}>
            <span className={styles.table__title}>  {item.responsible.map((name, idx) => (
              <span className={styles.table__title} key={idx}>{name}<br/></span>
            ))} </span>
