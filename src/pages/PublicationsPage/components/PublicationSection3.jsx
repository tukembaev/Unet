...
const PublicationSection3 = ({openSection = {} ,setOpenSection ,data }) => {
  return (
    ...
    <div className={styles.section_header} >
     <img src={openSection.section3 ? down : right } className={styles.size} alt="" onClick={() => setOpenSection((prevState) => ({
       ...prevState,
    ...
    {openSection.section3 ? <div className={styles.section_body}>
...
<h3>Kyrgyz State Technical University: Bishkek, KG</h3>
               ...
               <div className={styles.card_body}>
                 ...
                 <p>date</p>
                   ...
                   <img src={openSection.section3more ? down : right } className={styles.size} alt="" onClick={() => setOpenSection((prevState) => ({
       ...prevState,
