...
const PublicationSection2 = ({openSection = {} ,setOpenSection ,data}) => {
  return (
    ...
    <div className={styles.section_header} >
     <img src={openSection?.section2 ? down : right } className={styles.size} alt="" onClick={() => setOpenSection((prevState) => ({
       ...prevState,
    ...
    {openSection.section2 ? <div className={styles.section_body}>
...
<h3>Kyrgyz State Technical University: Bishkek, KG</h3>
               ...
               <div className={styles.card_body}>
                 ...
                 <p>date</p>
                   ...
                   <img src={openSection?.section2more ? down : right } className={styles.size} alt="" onClick={() => setOpenSection((prevState) => ({
       ...prevState,
       section2more: !prevState.section2more,
               ...
               <div className={styles.card_body_more} >
                 ...
                 Источники : <div className={styles.card_footer_members}>
