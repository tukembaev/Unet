        ...
        <table className={styles.table__wrapper}>
          <thead className={styles.table__head}>
            <tr className={styles.table__row}>
              ...
              <th className={styles.table__item}>
                <span className={styles.table__title}>Длит.обучения</span>
              </th>
              <th className={styles.table__item}>
                <span className={styles.table__title}>Годы обучения</span>
              </th>
              <th className={styles.table__item}>
                <span className={styles.table__title}>Кл.Предметов</span>
              </th>
              <th className={styles.table__item}>
                <span className={styles.table__title}>Кл.Семестров</span>
              </th>
              <th className={styles.table__item}>
              ...
              >
                <span className={styles.table__title}>Скачать Excel</span>
              </th>
            </tr>
          </thead>
          {data?.syllabuses.length === 0 ? (
            ...
            data?.syllabuses?.map((item, index) => {
              return (
                <tbody
                ...
                >
                  <tr className={styles.table__row}>
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>{index}</span>
                    </td>
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>{item.cipher}</span>
                    </td>
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>
                        {item.direction}
                    ...
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>{item.years}</span>
                    </td>
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>
                        {item.semesters}
                    ...
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>{item.hours}</span>
                    </td>
                    <td
                      className={styles.table__item}
                      style={{ borderRight: "0.5px solid black" }}
