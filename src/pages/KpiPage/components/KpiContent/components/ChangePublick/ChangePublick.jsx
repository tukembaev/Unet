...
export default function ChangePublick({ data, setClose, setRender , setNotify }) {
  // states
        ...
        <div className={styles.change__box}>
          <div className={styles.change__item}>
            <div className={styles.requiredField}>
              <h3 className={styles.change__title}>Наименование <span className={styles.required_img}>*</span></h3>
            </div>
            <TextareaAutosize
              id="text"
              name="text"
          ...
          <div className={styles.change__item}>
            <div className={styles.requiredField}>
              <h3 className={styles.change__title}>Ссылка <span style={{ color: "orange" }}>*</span></h3>
            </div>
            <TextareaAutosize
              id="link"
              name="link"
          ...
          <div className={styles.change__item}>
            <div className={styles.requiredField}>
              <h3 className={styles.change__title}>Страна <span className={styles.required_img}>*</span></h3>
            </div>
          ...
          <div className={styles.change__item}>
            <div className={styles.requiredField}>
              <h3 className={styles.change__title}>Файл <span style={{ color: "orange" }}>*</span></h3>
            </div>
            {data?.files !== 0 ? (
              <div
