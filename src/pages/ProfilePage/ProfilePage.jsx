      ...
      <div className={styles.both_side}>
        ...
        <div className={styles.right_side}>
          <div className={styles.profile_right_info}>
            ...
            <ModalWindow
              openModal={openModalNumber}
              setOpenModal={setOpenModalNumber}
              modalText={"Введите ПИН "}
            >
              <PinCode setPinCode={setPinCode} passwordVisible={true} />
              <Button
                onClick={() => setOpenModalNumber(false)}
                className={styles.btn_pin_close}
              >
                Закрыть
              </Button>
              <Button
                onClick={changePhoneNumberValidation}
                className={styles.btn_pin}
              >
                Подтвердить
              </Button>
            ...
            {isShownNum && (
              <div className={styles.info6}>
                ...
                <input
                  ...
                  className={styles.password_change}
                />
                <Button className={styles.btn2} onClick={handleSubmit2}>
                  Изменить
                </Button>
              </div>
            )}
