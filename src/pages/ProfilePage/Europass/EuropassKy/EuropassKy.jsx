    ...
    <div className={styles.personal_wrapper}>
      <div className={styles.header}>
        ...
        <div className={styles.header_body}>
            ...
            <button className={styles.btn1} onClick={() => navigate('/europass') }  style={{}} >Русский </button>
            <button className={styles.btn1} onClick={() => navigate('/europassen') }   >English</button>
            <button className={styles.btn1}  >Кыргызча</button>
         </div>
          </div>
      </div>
    <button style={{width:'150px', marginBottom:'30px'}} onClick={() => navigate('/personalcard') } className={styles.btn1}>Артка</button>
      ...
      <h3>Жашырыла турган бөлүмдөру тандаңыз </h3>
        ...
        <div className={styles.list}>
          ...
          <div className={styles.item}>
            ...
            <div>
              ...
              {info?.military_registration?.is_fit? (<p>Турук</p>) : (<p>Турук эмес</p>)}
            </div>
          <div className={styles.item}>
            <div>
        ...
        <div className={styles.list}>
          ...
          <h3>Жакында туулган иштине аракет кылгандан баштапки ишин аткаруу</h3>
          <div className={styles.item}>
        ...
        <button className={styles.btn1} style={{marginLeft:'25px'}} onClick={() => navigate('/finaleuropassky')}>Европас формасы бекитүү</button>
      </div>
      </div>
    </Layout>
  )
