      ...
      <div className={styles.personal_wrapper2}>
        <div className={styles.header}>
          ...
          <div className={styles.header_body}>
            ...
            <button className={styles.btn1} style={{ marginLeft: '25px' }} onClick={handlePrint}>
              Print
            </button>
          </div>
        </div>

        <button onClick={() => navigate('/europass')} style={{ width: '100px', marginRight: '30px' }} className={styles.btn1}>
          Back
        </button>
        ...
        {logo ? (
          <div style={{ marginTop: '20px', width: '280px', display: 'flex', justifyContent: 'space-between' }}>
            <img
              onClick={() => {
                setPolit(false);
                setEuro(true);
        ...
        <div
          ...
          style={{ margin: '0 auto', border: 'none', zIndex: '5', maxHeight: '3500px', display: 'flex', flexDirection: 'column', overflowX: 'auto' }}
          ref={componentRef}
        >
          <div style={{ paddingTop: '45px', justifyContent: 'center', display: 'flex', gap: '200px' }}>
            ...
            <div>
              <img src={user.image} alt="" style={{ width: '150px', height: '200px', zIndex: '2', objectFit: 'cover' }} />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', margin: 'auto', gap: '20px' }}>
            <div className={styles.body_left} style={{ zIndex: '5', gap: '0' }}>
              ...
              <div className={styles.body_info}>
              {info?.residence_place?.street ? (<h4 className={styles.body_list_left}  >Address</h4>) : (null)}
              ...
              <div className={styles.body_info}>
                {user_changes?.numberPhone ? <h4 className={styles.body_list_left}>Mobile</h4> : null}
                {user_changes?.numberPhone ? <p>{user?.numberPhone}</p> : null}
              </div>

              <div className={styles.body_info}>
                {user_changes?.email ? <h4 className={styles.body_list_left}>Email</h4> : null}
              ...
              <div className={styles.body_info}>
                {user_changes?.data_of_birth ? <h4 className={styles.body_list_left}>Date of Birth</h4> : null}
              ...
              <div className={styles.body_info}>
                {check?.education ? (
                  <div>
                    ...
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Start of Studies</h4>
              ...
              <div className={styles.body_info}>
                {check?.military_registration ? (
                  <div>
                    <div className={styles.body_list}>
                      <h2 className={styles.body_list_left}>Military Registration</h2>
                    </div>
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Fitness for Military Service</h4>
                      {check?.military_registration.is_fit ? <h4>Fitness</h4> : <h4>Unfit</h4>}
                    </div>
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Military Draft Board</h4>
                    ...
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Military Specialty</h4>
              ...
              <div className={styles.body_info}>
                { check?.trainings.length === 0 ? null : (
                  <div>
                    <div className={styles.body_list}>
                      <h2 className={styles.body_list_left}>Professional Development</h2>
                    </div>
                    <div className={styles.body_list}>
                    ...
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Type of Training</h4>
                      <h4>{check?.trainings[0]?.kind}</h4>
                    </div>
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Type of Certification</h4>
              ...
              <div className={styles.body_info}>
                {check?.employment === true && check?.employment?.experiences.length ? (
                  <div>
                    <div className={styles.body_list}>
                      <h2 className={styles.body_list_left}>Current Employment</h2>
                    </div>
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Occupied Position</h4>
                    ...
                    <div className={styles.body_list}>
                      <h4 className={styles.body_list_left}>Organization Name</h4>
                      <h5>{info?.employment?.experiences[0].organization}</h5>
