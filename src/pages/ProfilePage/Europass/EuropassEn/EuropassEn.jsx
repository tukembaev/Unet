    ...
    <div className={styles.personal_wrapper}>
      <div className={styles.header}>
        ...
        <div className={styles.header_body}>
            ...
            <button className={styles.btn1} onClick={() => navigate('/europass') }   >Русский </button>
            <button className={styles.btn1}  >English</button>
            <button className={styles.btn1}  onClick={() => navigate('/europassky') }  >Кыргызча</button>
         </div>
          </div>
      </div>
    <button style={{width:'150px', marginBottom:'30px'}} onClick={() => navigate('/personalcard') } className={styles.btn1}>Back</button>
      ...
      <h3>Regarding the fields to be hidden </h3>
        ...
        {info?.employment?.experiences === 0 ? (null) : (<div className={styles.list}>
        ...
        <button className={styles.btn1} style={{marginLeft:'25px'}} onClick={() => navigate('/finaleuropassen')}>Generate summary</button>
      </div>
