...
import { getPersonalEmployee, patchPersonalEmployee } from "../../../../../service/PersonalCardService";
    ...
    {change? ( <div className={styles.Education_true}>
           <div className={styles.EducationHeader}>
            ...
            <li className= {styles.Education_list_true}>
             ...
             <input onChange={(e) => setInstitution(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            ...
            <li className= {styles.Education_list_true}>
             ...
             <input onChange={(e) => setDepartment(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            ...
            <li className= {styles.Education_list_true}>
             ...
             <input onChange={(e) => setForm(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Год вступления</h3>
             <input onChange={(e) => setEntered(e.target.value)} type="date" className={styles.Education_info_change_inp} />
             
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Год окончания/ухода</h3>
             <input onChange={(e) => setGraduated(e.target.value)} type="date" className={styles.Education_info_change_inp} />
             
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title} placeholder='Курс ухода'>Если не окончил </h3>
             <input onChange={(e) => setDisposed(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Специальность по окончанию</h3>
             <input onChange={(e) => setQualification(e.target.value)} type="text" className={styles.Education_info_change_inp} />
             
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Номер диплома</h3>
             <input onChange={(e) => setDiploma_number(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Ученая степень</h3>
             <input onChange={(e) => setAcademic_degree(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Ученое звание</h3>
             <input onChange={(e) => setAcademic_rank(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>
            ...
            {english? (<ul className={styles.Education_desc}>
            
          
 
            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>билим берүү мекемеси</h3>
             <input onChange={(e) => setInstitutionKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            ...
            <li className= {styles.Education_list_true}>
             ...
             <input onChange={(e) => setDepartmentKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            ...
            <li className= {styles.Education_list_true}>
             ...
             <input onChange={(e) => setFormKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Кирген жылы</h3>
             <input onChange={(e) => setEnteredKy(e.target.value)} type="date" className={styles.Education_info_change_inp} />
             
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Бүтүрүү / бүтүрүү жылы</h3>
             <input onChange={(e) => setGraduatedKy(e.target.value)} type="date" className={styles.Education_info_change_inp} />
             
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title} placeholder='Курс ухода'>Окууну бүтпөсө </h3>
             <input onChange={(e) => setDisposedKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Бүтүрүү адистиги</h3>
             <input onChange={(e) => setQualificationKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
             
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Диплом номери</h3>
             <input onChange={(e) => setDiploma_numberKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Академиялык даража</h3>
             <input onChange={(e) => setAcademic_degreeKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>

            <li className= {styles.Education_list_true}>
             <h3 className={styles.Education_title}>Академиялык наам</h3>
             <input onChange={(e) => setAcademic_rankKy(e.target.value)} type="text" className={styles.Education_info_change_inp} />
            </li>
                ...
                <div className={styles.change_btn}>
                    <button onClick={() => setChange(false)} className={styles.change_btn_Cancel}><p>Отмена</p></button>
                    <button onClick={handleSubmit} className={styles.change_btn_save}><p  style={{color: 'white',}}>Сохранить Изменения</p></button>
                </div>
            </div>
           ...
           <div className={styles.EducationHeader}>
            ...
            <div className={styles.headerRight}>
                <img src={pencil} onClick={() =>setChange(true)} className={styles.headerRight_info}/>
            </div>
           </div>
           ...
           <li className= {styles.Education_list}>
            ...
            <p className={styles.Education_info}>{education?.institution}</p>
           </li>
           ...
           <li className= {styles.Education_list}>
            ...
            <p className={styles.Education_info}>{education?.academic_degree}</p>
           </li>
