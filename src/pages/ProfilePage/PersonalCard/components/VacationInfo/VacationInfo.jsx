...
import { deleteVacations, getPersonalEmployee, patchPersonalEmployee } from "../../../../../service/PersonalCardService";
 ...
 <div className= {styles.wrapper}>
    ...
    {change? ( <div className={styles.Vacation_true}>
           <div className={styles.VacationHeader}>
            ...
            {info?.vacations?.map((item) => (<div>
             <p style={{color:'black', width: '80%', textAlign:'left',margin: 'auto',  marginLeft: '8%',marginTop:'15px', fontSize: '20px'}}>{item?.kind} </p>
           ...
           <li className= {styles.Vacation_list}>
            ...
            <p className={styles.Vacation_info}>{item?.recall_order_date}</p>
           </li>
            
            
           <li className= {styles.Vacation_list}>
            <p className={styles.Vacation_title}>Дата</p>
            <p className={styles.Vacation_info}>{item?.leave_order_date}</p>
           </li>
            
           <button onClick={() => deleteUserInfo(item.id)}  className={styles.change_btn_delete}>
            ...
            <div className={styles.Vacation_change_header}>
             <input onChange={(e) => setKind(e.target.value)} type="text" placeholder='Вид отпуска' className={styles.Vacation_info_Header_inp} />
            ...
            <li className= {styles.Vacation_list_true}>
             ...
             <input onChange={(e) => setPeriod(e.target.value)} type="text" className={styles.Vacation_info_change_inp} />
            </li>
            ...
            <li className= {styles.Vacation_list_true}>
             ...
             <input onChange={(e) => setStarted(e.target.value)} type="date" className={styles.Vacation_info_change_inp} />
            ...
            <li className= {styles.Vacation_list_true}>
             ...
             <input onChange={(e) => setEnded(e.target.value)} type="date" className={styles.Vacation_info_change_inp} />
            ...
            <li className= {styles.Vacation_list_true}>
             ...
             <input onChange={(e) => setLeave_order(e.target.value)} type="text" className={styles.Vacation_info_change_inp} />
             
            </li>

            <li className= {styles.Vacation_list_true}>
             <h3 className={styles.Vacation_title}>Дата</h3>
             <input onChange={(e) => setLeave_order_date(e.target.value)} type="date" className={styles.Vacation_info_change_inp} />
            </li>

            <li className= {styles.Vacation_list_true}>
             <h3 className={styles.Vacation_title}>Не использованные дни</h3>
             <input onChange={(e) => setUnused_days(e.target.value)} type="text" className={styles.Vacation_info_change_inp} />
             
            </li>

            <li className= {styles.Vacation_list_true}>
             <h3 className={styles.Vacation_title}>Отозвать с отпуска</h3>
             <input onChange={(e) => setRecalled(e.target.value)} type="date" className={styles.Vacation_info_change_inp} />
            </li>

            <li className= {styles.Vacation_list_true}>
             <h3 className={styles.Vacation_title}>Не оплаченные дни</h3>
             <input onChange={(e) => setUnpaid_days(e.target.value)} type="text" className={styles.Vacation_info_change_inp} />
            </li>

            <li className= {styles.Vacation_list_true}>
             <h3 className={styles.Vacation_title}>Приказ</h3>
             <input onChange={(e) => setRecall_order(e.target.value)} type="text" className={styles.Vacation_info_change_inp} />
            </li>

            <li className= {styles.Vacation_list_true}>
             <h3 className={styles.Vacation_title}>Дата</h3>
             <input onChange={(e) => setRecall_order_date(e.target.value)} type="date" className={styles.Vacation_info_change_inp} />
            </li>
