...
const ManningTableInfo = () => {
 ...
 <div className= {styles.wrapper}>
    ...
    {change? ( <div className={styles.Staffing_true}>
           <div className={styles.StaffingHeader}>
            ...
            <div className={styles.Staffing_change_header}>
             ...
             <input type="text"  className={styles.Staffing_info_Header_inp} />  
                </div>
            ...
            <li className= {styles.Staffing_list_true}>
             ...
             <input type="text" className={styles.Staffing_info_change_inp} />
            </li>
            ...
            <div className={styles.change_btn}>
             ...
             <button className={styles.change_btn_add}><p  style={{color: 'white', }}>Добавить еще</p></button>
            </div>
                ...
                <li className={styles.Staffing_list_footer}>
                 ...
                 <input type="text" placeholder='Номер приказа' className={styles.Staffing_info_change_inp} />
                 <input type="date" className={styles.Staffing_info_change_inp} />
                ...
                <div className={styles.change_btn}>
                    ...
                    <button className={styles.change_btn_save}><p  style={{color: 'white', }}>Сохранить Изменения</p></button>
                </div>
            </div>
        ...
        ( <div className={styles.Staffing}>
           ...
           <p style={{color:'white', width: '80%', textAlign:'left',margin: 'auto',  marginLeft: '8%',marginTop:'15px'}}>Подразделение </p>
           <p style={{color:'white', width: '80%', textAlign:'left',margin: 'auto',  marginLeft: '8%',marginTop:'15px'}}>ОРПО </p>
           <ul className={styles.Staffing_desc}>
