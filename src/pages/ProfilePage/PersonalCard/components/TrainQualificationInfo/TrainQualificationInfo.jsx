...
import { deleteTrainings, getPersonalEmployee, patchPersonalEmployee, postQualifications } from "../../../../../service/PersonalCardService";
    ...
    <div className={styles.wrapper}>
      <div style={{ width: "100%", height: "100%" }}>
        {change ? (
          ...
          {info?.trainings?.filter((elem) => elem.title !== null).map((item) => (
             <ul className={styles.Activity_desc}>
              ...
              <li className={styles.Activity_list}>
                ...
                <p className={styles.Activity_info}>{item?.certification_type}</p>
              </li>

              <li className={styles.Activity_list}>
                <p className={styles.Activity_title}>Документ</p>
                <button className={styles.change_btn_download}>
                  <a target="_blank" href={item?.certification} style={{ color: "white", }}>
                    Скачать документ
                  </a>
                </button>
