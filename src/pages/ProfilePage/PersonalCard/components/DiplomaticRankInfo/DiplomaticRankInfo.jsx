...
import { deleteRanks, getPersonalEmployee, patchPersonalEmployee, postDiplomaticRank } from "../../../../../service/PersonalCardService";
  ...
  return (
    <div>
        {change? (<div className={styles.Diplomatic}>
           ...
           {diplomatic?.map((item) => <ul className={styles.Diplomatic_desc}>
            ...
            <li className= {styles.Diplomatic_list}>
             <h3 className={styles.Diplomatic_title}>Название</h3>
             <input onChange={(e) => setTitle(e.target.value)} type="text" className={styles.Diplomatic_info_change_inp} />
            </li>
 
            <li className= {styles.Diplomatic_list}>
             <h3 className={styles.Diplomatic_title}>Звание</h3>
             <input onChange={(e) => setRank(e.target.value)} type="text" className={styles.Diplomatic_info_change_inp} />
            ...
            <li className= {styles.Diplomatic_list}>
             <h3 className={styles.Diplomatic_title}>Дата</h3>
             <input onChange={(e) => setAssigned(e.target.value)} type="date" className={styles.Diplomatic_info_change_inp} />
            ...
            <li className= {styles.Diplomatic_list}>
             ...
             <input onChange={(e) => setCertification(e.target.files[0])} type="file" className={styles.Diplomatic_info_change_inp} />
           ...
           {diplomatic?.map((item) => <ul className={styles.Diplomatic_desc}>
            ...
            <button className={styles.change_btn_download}><a target='_blank' href={item?.certification}  style={{color: 'white', }}>Скачать документ</a></button>
