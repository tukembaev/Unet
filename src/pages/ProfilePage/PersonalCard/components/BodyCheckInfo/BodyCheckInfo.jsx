...
import { deleteBodyCheck, getPersonalEmployee, getPersonalEmployeeKyrgyz, patchPersonalEmployee, postBodyCheck } from "../../../../../service/PersonalCardService";
  ...
  return (
    <div>
        {change? (<div className={styles.BodyCheck}>
           ...
           {bodyCheck.map((item) => ( <ul className={styles.BodyCheck_desc}>
            ...
            <button  className={styles.change_btn_download}><a target='_blank' href = {item?.certification} style={{color: 'white', fontSize:'14px'}}>Скачать документ</a></button>
           ...
           <ul className={styles.BodyCheck_desc}>
            ...
            <li className= {styles.BodyCheck_list}>
             <h3 className={styles.BodyCheck_title}>Место прохождения</h3>
             <input onChange={(e) => setBirth_place(e.target.value)} type="text" className={styles.BodyCheck_info_change_inp} />
            </li>
 
            <li className= {styles.BodyCheck_list}>
             <h3 className={styles.BodyCheck_title}>Дата</h3>
             <input onChange={(e) => setPassed(e.target.value)} type="date" className={styles.BodyCheck_info_change_inp} />
            </li>

            <li className= {styles.BodyCheck_list}>
             <h3 className={styles.BodyCheck_title}>Файл</h3>
             <input onChange={(e) => setCertification(e.target.files[0])} type="file" className={styles.BodyCheck_info_change_inp} />
            </li>
