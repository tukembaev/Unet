...
const LanguagesInfo = () => {
    ...
    const request_type2 = [{id: 0, label: "Да"}, {id: 1, label: "Нет"}];
    const request_type = [{id: 0, label: "a1"}, {id: 1, label: "a2"} ,{id: 2, label: "b1"}, {id: 3, label: "b2"} , {id: 4, label: "c1"} ,{id: 5, label: "c1"}];
    ...
    useEffect(() => {checkMotherTongue()} , [type_doc === 'Да' || type_doc === 'Нет'])
  ...
  return (
    <div>
        {change? (<div className={styles.LanguagesInfo}>
           ...
           <ul className={styles.LanguagesInfo_desc}>
            ...
            <li className= {styles.LanguagesInfo_list}>
             ...
             {info?.languages[0]?.is_mother_tongue ? (<p className={styles.LanguagesInfo_info}>даff</p>) : (<p className={styles.LanguagesInfo_info}>Нет</p>)}
             
            </li>
 
            <li className= {styles.LanguagesInfo_list}>
             <h3 className={styles.LanguagesInfo_title}>Знание языков</h3>
             <p className={styles.LanguagesInfo_info}>{info?.languages[0]?.language}</p>
            </li>

            <li className= {styles.LanguagesInfo_list}>
             <h3 className={styles.LanguagesInfo_title}>Уровень знания:</h3>
             <p className={styles.LanguagesInfo_info}>{info?.languages[0]?.level}</p>
            </li>
            ...
            <li className= {styles.LanguagesInfo_list_true}>
             <h3 className={styles.LanguagesInfo_title}>Знание Гос.языка</h3>
             <Dropdown setId={setId} setType={setType_doc} title = {'Знание Гос.языка'} data = {request_type2 ?? []}/>
            ...
            <li className= {styles.LanguagesInfo_list_true}>
             <h3 className={styles.LanguagesInfo_title}>Знание языков</h3>
             <input onChange={(e) => setLanguage(e.target.value)} type="text" className={styles.LanguagesInfo_info_change_inp} />
            </li>

            <li className= {styles.LanguagesInfo_list_true}>
             <h3 className={styles.LanguagesInfo_title}>Уровень знания</h3>
             <Dropdown setId={setId} setType={setLevel} title = {'Уровень знания'} data = {request_type ?? []}/>
            ...
            {add? (
            <ul style={{display: 'flex',justifyContent: 'space-around'}} className={styles.LanguagesInfo_desc_foot}>

            <li className= {styles.LanguagesInfo_list_true}>
             <h3 className={styles.LanguagesInfo_title}>Знание языков</h3>
             <input type="text" className={styles.LanguagesInfo_info_change_inp} />
            </li>
            ...
            <button className={styles.LanguagesInfo_btn} onClick={() => setAdd(false)}>x</button >
            </ul>
            ) : (null)}
           ...
           {info?.languages.map((item) =>(
            ...
            <li className= {styles.LanguagesInfo_list}>
             <h3 className={styles.LanguagesInfo_title}>Знание Гос языка  </h3>
             {item?.is_mother_tongue ? (<p className={styles.LanguagesInfo_info}>да</p>) : (<p className={styles.LanguagesInfo_info}>Нет</p>)}
            </li>
 
            <li className= {styles.LanguagesInfo_list}>
             <h3 className={styles.LanguagesInfo_title}>Знание иностранных языков</h3>
             <p className={styles.LanguagesInfo_info}> {item?.language } </p>
            </li>

            <li className= {styles.LanguagesInfo_list}>
             <h3 className={styles.LanguagesInfo_title}>Уровень знания языка:</h3>
