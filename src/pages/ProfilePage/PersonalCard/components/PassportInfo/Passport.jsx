        ...
        {change ? (
          <div className={styles.Location_true}>
            ...
            <div className={styles.Location_change_block}>
              ...
              {english? (<ul className={styles.Location_desc_true}>
                <li className={styles.Location_list_true}>
                ...
                <button
                  ...
                  className={styles.change_btn_Cancel}
                >
                  <p onClick={() => setKyrgyz(true)}>Добавить данные на кыргызском языке</p>
                </button>
              
              </ul>) : null}


              {kyrgyz? (<ul className={styles.Location_desc_true}>
                <li className={styles.Location_list_true}>
