...
import { deleteReletives, getPersonalEmployee, patchPersonalEmployee } from '../../../../../service/PersonalCardService';
...
const FamilyStatusInfo = ({data}) => {
 ...
 <div className= {styles.wrapper}>
    ...
    {change? ( <div className={styles.Family_true}>
           ...
           <p style={{color:'black', fontSize: '16px', width: '80%', textAlign:'left',margin: 'auto',  marginLeft:' 8%', marginTop: '50px', marginBottom: '50px', fontFamily: '"Inter", sans-serif'}}>{info.family?.marital_status}</p>
           <h2 style={{color:'black', fontSize: '16px', width: '80%', textAlign:'left',margin: 'auto',  marginLeft: '20px',}}>Сведение о родественниках </h2>
           ...
           <button onClick={() => deleteUserInfo(item.id)}  className={styles.change_btn_delete}>
            ...
            <div className={styles.Family_change_header}>
             <input onChange={(e) => setMarital_status(e.target.value)}  type="text" placeholder='Семейное положение на момент заполнения' className={styles.Family_info_Header_inp} />
            ...
            <li className= {styles.Family_list}>
             ...
             <input onChange={(e) => setName(e.target.value)} type="text" className={styles.Family_info_change_inp} />
            </li>
 
            <li className= {styles.Family_list}>
             <h3 className={styles.Family_title}>Фамилия</h3>
             <input onChange={(e) => setSurname(e.target.value)} type="text" className={styles.Family_info_change_inp} />
            ...
            <li className= {styles.Family_list}>
             ...
             <input onChange={(e) => setPantronymic(e.target.value)} type="text" className={styles.Family_info_change_inp} />
            ...
            <li className= {styles.Family_list}>
             ...
             <input onChange={(e) => setBorn(e.target.value)} type="date" className={styles.Family_info_change_inp} />
            
            </li>

            <li className= {styles.Family_list}>
             <h3 className={styles.Family_title}>Степень родства</h3>
             <input onChange={(e) => setRelationship(e.target.value)} type="text" className={styles.Family_info_change_inp} />
           ...
           <p style={{color:'black', fontSize: '16px', width: '80%', textAlign:'left',margin: 'auto', marginTop: '50px', marginBottom: '50px', fontFamily: '"Inter", sans-serif', marginLeft:'50px'}}>{info.family?.marital_status}</p>
           <h2 style={{color:'black', fontSize: '16px', width: '80%', textAlign:'left',margin: 'auto',}}>Сведение о родественниках </h2>
           {info.family?.relatives.map((item) => (
            <ul className={styles.Family_desc}>
