...
import { getAllSupport, getEmployeeSupport } from '../../../../service/SupportService';
import { setSupportByAll } from '../../../../store/slices/SupportSlice';
                ...
                return (
                  ...
                  >
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>{item.request_num}</span>
                    </td>
                    <td className={styles.table__item}>
                    ...
                    <td className={styles.table__item}>
                      <span className={styles.table__title}>{item.request_type}</span>
                    </td>
                    <td className={styles.table__item}>
