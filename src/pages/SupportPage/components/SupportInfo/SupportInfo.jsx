...
import {  getSupportDataById, updateSupportMessage } from '../../../../service/SupportService';
import { setSupportById, setUpdatedSupport } from '../../../../store/slices/SupportSlice';
import userInfo from '../../../../utils/userInfo';
import ChatTaskItem from '../../../TasksPage/components/TaskItem/TaskItemInfo/ChatTaskItem/ChatTaskItem';
...
const SupportInfo = () => {
  ...
  return (
    ...
    <div className={styles.task_info_left_header}>
      <div>
        {" "}
        <h2>{supportData.topic} ({supportData.request_type})</h2>
      </div>
    ...
    <div className={styles.simple_raports_footer}>
      <div className={styles.simple_raports_footer_btns}>
        ...
        {supportData.status === 'На рассмотрении' && user.is_admin_of ?  <Button className={styles.btn1}    onClick={() => {
    ...
    <div><ChatTaskItem globalChat = {false} SupportChat = {true} /></div>
