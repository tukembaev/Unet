        ...
        <div className={styles.titile__wrapper}>
          ...
          <div>
            {width > 1000 ? (
              ...
              // <SlidingPaneUtil size='50%' title='Новое обращение в службу' state={state} setState = {setState}><SupportForm setRender ={setRender} setState = {setState}/> </SlidingPaneUtil>
              <SlidingPaneUtil
                size="100%"
                title="Новое обращение в службу"
                state={state}
