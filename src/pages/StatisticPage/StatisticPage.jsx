    ...
    <Layout>
      ...
      {user.is_admin_of ? (
        <div style={{ marginBottom: "15px" ,float:'right'}}>
          ...
          <EmployeeSelectUserId selectedEmployee={setSelectedEmp} isMulti={false} />
        </div>
      ) : (
        <div style={{ marginBottom: "15px",float:'right' }}>
          <h3>{user.division}</h3>
        ...
        <div className={styles.statistic_blured_block}>
          <div className={styles.block_top_section}>
            <HeaderCards data={statisticDatas.ProfileCards} isUser={selectedEmp === user.userId ? true : false} /> 
          </div>
