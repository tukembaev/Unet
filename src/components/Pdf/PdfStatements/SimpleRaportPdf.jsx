     ...
     <div className={styles.simple_raports_info_wrapper} ref={componentRef}>
      ...
      <div className={styles.simple_raports_info_body}>
        ...
        {info.prorectorcheck.includes('Отказано') ? <p className={styles.text_sign}>Подпись проректора: <br />Отказано </p>: <p>Подпись проректора: <br /> <br /> </p> }
          {info.prorectorcheck === null ? '' : <div style={{ height: "auto", maxWidth: 64, margin: "0 auto", width: "100%" }}>
            <QRCode
              size={256}
        ...
        {info.ispolnpodcheck.includes('Отказано') ? <p className={styles.text_sign}>Подпись заявителя: <br />Отказано </p>: <p>Подпись заявителя: <br /> <br /> </p> }
          {info.ispolnpodcheck === null ? '' : <div style={{ height: "auto", maxWidth: 64, margin: "0 auto", width: "100%" }}>
            <QRCode
              size={256}
              style={{ height: "auto", maxWidth: "100%", width: "100%" }}
              value={info.prorectorcheck}
        ...
        <div className={styles.prorector_check}>
        {info.rukovpodcheck.includes('Отказано') ? <p className={styles.text_sign}>Подпись руководителя: <br />Отказано </p>: <p>Подпись руководителя: <br /> <br /> </p> }
        
          {info.rukovpodcheck === null ? '' : <div style={{ height: "auto", maxWidth: 64, margin: "0 auto", width: "100%" }}>
            <QRCode
              size={256}
              style={{ height: "auto", maxWidth: "100%", width: "100%" }}
