  ...
  return (
    <div className={styles.background_wrapper}>
      ...
      <div className={styles.background_body}>
        {data?.map((item) => (
            <div key={item?.id}
            className={ `${id === item?.id ? styles.background_child_active : styles.background_child}`}
      ...
      <div className={styles.background_footer}>
        <button className={styles.save_btn} onClick={() => handleSubmit()}>Сохранить</button>
