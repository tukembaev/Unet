      ...
      {user.user_type === "S" ? (
        ...
        <>
         <li>
            ...
            <NavLink className={styles.menu__link} to={`/alerts/${user.userId}`}>
              Главная
            </NavLink>
          </li>
          <li>
          ...
          <li>
            <NavLink className={styles.menu__link} to={`/student-discipline/`}>
              Регистрация
            </NavLink>
          </li>
          <li>
            ...
            <li>
              <NavLink className={styles.menu__link} to={`/tasks/${user.userId}`}>
                Задачи
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink className={styles.menu__link} to={`/statements/${user.userId}`}>
                Обращения
              </NavLink>
            </li>
            {user.division === 'Канцелярия' ? <NavLink className={styles.menu__link} to={`/chancellerys`}>
              Канцелярия
            </NavLink> : ''}
...
Главная</span>   
            ...
            <li>
              ...
              <img src={academ} alt="" style={{marginTop:'11px'}} />
                <span style={{paddingTop:'3px'}}>Академический Календарь</span>   
              </NavLink>
            </li>
            <li>
              <NavLink className={styles.menu__link} to={`/discipline/`}>
            ...
            <li>
              <NavLink className={styles.menu__link} to={`/kpi/`}>
              <img src={disciplines} alt="" />
             <span style={{paddingTop:'3px'}}>   KPI</span>   
              </NavLink>
            </li>
     ...
     <li>
            ...
            <li>
              ...
              {user.division === 'Канцелярия' ? <NavLink className={styles.menu__link} to={`/chancellerys`}>         <img src={home} alt="" />
              <span style={{paddingTop:'2px'}}>  Канцелярия</span> 
              </NavLink> : ''}
              <li>
                <NavLink className={styles.menu__link} to={`/orders/${user.userId}`}>         <img src={order} alt="" />
                <span style={{paddingTop:'2px'}}> Приказы</span> 
                </NavLink>
              </li>
              <li>
                <NavLink className={styles.menu__link} to={`/chats/`}>         <img src={chat} alt="" />
                <span style={{paddingTop:'1px'}}>Мессенджер</span> ктуры
                </NavLink>
              </li>
              <li>
                <NavLink className={styles.menu__link} to={`/statistic/`}>         <img src={chart} alt="" />
                <span style={{paddingTop:'1px'}}>Статистика</span> 
                </NavLink>
              </li>
              <li>
                <NavLink className={styles.menu__link} to={`/support`}>         <img src={faq} alt="" />
                <span style={{paddingTop:'2px'}}>Поддержка 24/7</span> 
                </NavLink>
              </li>
              <li>
                <NavLink className={styles.menu__link} to={`/academ-calendar/`}>         <img src={calendar365} alt="" />
                <span style={{paddingTop:'2px'}}> Планирование</span> 
                </NavLink>
              </li>
              {user.is_admin_of ? <li>
                <NavLink className={styles.menu__link} to={`/register_person`}>         <img src={registration} alt="" />
              ...
              <li>
                <NavLink className={styles.menu__link} to={`/team`}>         <img src={teams} alt="" />
                <span style={{paddingTop:'2px'}}>Команды</span> 
                </NavLink>
              </li>
              <li>
                   <p className={styles.menu__link} onClick={handleSwitchToStudy}>         <img src={lessonsmenu} alt="" />
