...
import styles from "./DirectorForm.module.scss";
...
import DirectorCriteria from "./components/DirectorCriteria";
import DirectorCategoty from "./components/DirectorCategoty";
...
function DirectorForm({ setRender, setState }) {
  //UseState
    ...
    if (direction === "") {
      ...
      try {
        ...
        let response = await postKpi({
          ...
          country,
          published,
          position: isDirector === true ? "Директор" : "Сотрудника",
          kpi_authors,
          status: "В ожидании",
        });
