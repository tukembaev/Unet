...
const DynamicFields2 = ({ component, onValueChange , handleAddComponent , type , request_type ,title  }) => {
    ...
    const handleChange = (event) => {
      ...
      const handleAddComponent2 = () => {
        setDynamicInput3(prevComponents => [...prevComponents, { id: Date.now(), title: '' }]);
    };
  ...
  return (
    <div className={styles.card_field}>
        ...
        {dynamicInput3.length === 0 && type !== 'Сектор'  ?      <div style={{width:'250px' , paddingTop:'15px'}}>
          <Dropdown setId={setId} setType={setType3} handleAddComponent = {handleAddComponent2} title = {'Добавить поле'} data = {request_type ?? []}/>
          </div> : ''}
