  ...
  return (
    ...
    <div >
      ...
      <div className={styles.add_emp_form_top}>
         ...
         <AddEmpPosition structure_name = {data.structure_name} id = {data.id} setRender = {setRender} />
   
         <GetEmpPosition structure_name = {data.structure_name} id = {data.id} render = {render} setRender = {setRender} />
     ...
     <AddNewEmp  structure_name = {data.structure_name} id = {data.id} render = {render} setRender = {setRender}/> 

     <GetWorkingEmp selected_title = {data?.title}  structure_name = {data.structure_name} id = {data.id} render = {render} setRender = {setRender}/>
