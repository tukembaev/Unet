...
export const {setAllMineStructure , setStructureInfoById , setSend , setNewPosition , setPositionOfStructureById , setNewEmp , setEmpOfStructureById} = StructureSlice.actions;
