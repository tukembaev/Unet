...
import { degrees, PDFDocument, PDFName, PDFNumber, PDFString , StandardFonts } from 'pdf-lib';
...
export const AddWaterMark = async({name , type , count_turn , file , finalWaterMarks , order_date , order_number}) => {
...
firstPage.drawText(text2, {
  ...
  const new_file = new File([pdfBlob], 'order.pdf' ,  { type: 'application/pdf' } );
