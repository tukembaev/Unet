...
const EmployeeSelectEmployeeld = ({ selectedEmployee , isMulti , placeholder = "Выбрать сотрудника"}) => {
  ...
  const handleSelect = (dataEmployees) => {
    ...
    isMulti ? selectedEmployee(dataEmployees) :    selectedEmployee(dataEmployees.employee_id);
...
export default EmployeeSelectEmployeeld;