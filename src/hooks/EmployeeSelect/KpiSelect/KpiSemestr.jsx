...
import { getCategoryKpi , getCategoryKpiPPS} from "../../../service/PublicationService";

// import { getSemesters } from "../../service/FlowService";

const KpiSemesterSelect = ({ id, setSemester, isDirector }) => {
  ...
  const getData = async () => {
    try {
      let response = await getCategoryKpi(id, data);
...
export default KpiSemesterSelect;