...
export async function getUserStructure(data) {
  ...
  export async function createPositionToStructure(structure_name , id , {title , state , wage}) {
    return $apiJSON.post(`/organizations/posts/${structure_name}/${id}/`, {title , state , wage});
  }
  export async function createEmpToStructure(structure_name , id , {mov_employee_id , post , state , stavka}) {
    return $apiJSON.post(`/organizations/employees/${structure_name}/${id}/`, {mov_employee_id ,post , state , stavka});
  }
