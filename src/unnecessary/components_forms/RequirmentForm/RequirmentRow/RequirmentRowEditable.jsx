...
const RequirmentRowEditable = ({
  ...
  return (
    ...
    <tr key={requirmentItem.id}>
      ...
      {user.userId === 7 || user.userId === 505 ? <Button className="requirment__update" onClick={(e) => handleEditClick(e, requirmentItem)}>
          Изменить
        </Button>: '' }
       
      </td>
      {isDelete ? <td className={styles.actions__td}>
...
export default RequirmentRowEditable;
